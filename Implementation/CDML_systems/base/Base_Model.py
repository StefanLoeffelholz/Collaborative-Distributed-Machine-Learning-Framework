...
class ResNetClient(nn.Module):
    ...
    Contains the initial layers: conv1 and conv2_x.
    """
...
class ResNetServer(nn.Module):
    ...
    Contains the remaining layers: conv3_x, conv4_x, conv5_x, avg_pool, and fc.
    """
...
def split_resnet18():
    """
    Split ResNet-18 into client and server models.
    """
    client_model = ResNetClient(BasicBlock, [2, 2, 2, 2])
    server_model = ResNetServer(BasicBlock, [2, 2, 2, 2])
